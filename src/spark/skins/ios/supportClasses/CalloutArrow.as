...
package spark.skins.ios.supportClasses
{
	...
	import spark.skins.ios.CalloutTitleWindowSkin;
	...
	public class CalloutArrow extends UIComponent
	{
		...
		protected function get calloutSkin():CalloutTitleWindowSkin
		{
			return parent as CalloutTitleWindowSkin ;
		}
