...
package spark.skins.ios
{
	...
	import spark.skins.ios.supportClasses.CalloutArrow;
	 ...
	 */ 
	public class CalloutTitleWindowSkin extends MobileSkin
	{
		 ...
		 *  @productversion Flex 4.6
		 */
		public function CalloutTitleWindowSkin()
		{
			super();
		...
		override protected function createChildren():void
		{
			...
			if (!arrow)
			{
				arrow = new spark.skins.ios.supportClasses.CalloutArrow();
				arrow.id = "arrow";
